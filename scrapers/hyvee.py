...
class HyVeeSearcher:
    """Hy-Vee product search via Instacart's GraphQL search endpoint —
    the same API the other storefront scrapers use (same response shape),
    just on instacart.com with Hy-Vee's shop/zone ids."""
    ...
    def warmup(self, max_retries: int = 3):
        ...
        for attempt in range(1, max_retries + 1):
            try:
                r = self.session.get(
                    "https://www.instacart.com/store/hy-vee",
    ...
    def _search_once(self, query):
        ...
        variables = {
            "action": None,
            "query": query,
            "pageViewId": "0ad07e3e-06a0-5735-bbc7-f29c99e84bda",
        ...
        headers = {
            ...
            "referer": f"https://www.instacart.com/store/hy-vee/s?k={quote(query)}",
            "x-client-identifier": "web",
            "x-client-user-id": "21192267958514052",
            "x-ic-view-layer": "true",
            "x-page-view-id": "0ad07e3e-06a0-5735-bbc7-f29c99e84bda",
        }
        ...
        # with open(Path(__file__).parent / "hyvee_last_response.json", "w", encoding="utf-8") as f:
        #     json.dump(data, f, indent=2, ensure_ascii=False)
        # print("✓ Raw response saved to hyvee_last_response.json")
        ...
        return {
            ...
            "product_url": f"https://www.instacart.com/store/hy-vee/products/{evergreen_url}",
    ...
    def _get_description_once(self, product_id):
        ...
        url = f"https://www.instacart.com/store/hy-vee/products/{product_id}"
...
if __name__ == "__main__":
    ...
    hyvee = HyVeeSearcher(proxy)

    hyvee.warmup()

    product = hyvee.search("Hy-Vee Finely Shredded Mexican Natural Cheese 8 oz")
