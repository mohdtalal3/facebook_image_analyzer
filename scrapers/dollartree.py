...
class DollarTreeSearcher:
    """Dollar Tree product search via Instacart's GraphQL search endpoint —
    the same API the other storefront scrapers use (same response shape),
    just on instacart.com with Dollar Tree's shop/zone ids."""
    ...
    def warmup(self, max_retries: int = 3):
        ...
        for attempt in range(1, max_retries + 1):
            try:
                r = self.session.get(
                    "https://www.instacart.com/store/dollar-tree",
    ...
    def _search_once(self, query):
        ...
        variables = {
            "action": None,
            "query": query,
            "pageViewId": "4f7737f9-e03a-5bea-ba6e-e690f44c97ab",
        ...
        headers = {
            ...
            "referer": f"https://www.instacart.com/store/dollar-tree/s?k={quote(query)}",
            "x-client-identifier": "web",
            "x-client-user-id": "21192267958514052",
            "x-ic-view-layer": "true",
            "x-page-view-id": "4f7737f9-e03a-5bea-ba6e-e690f44c97ab",
        }
        ...
        # with open(Path(__file__).parent / "dollartree_last_response.json", "w", encoding="utf-8") as f:
        #     json.dump(data, f, indent=2, ensure_ascii=False)
        # print("✓ Raw response saved to dollartree_last_response.json")
        ...
        return {
            ...
            "product_url": f"https://www.instacart.com/store/dollar-tree/products/{evergreen_url}",
    ...
    def _get_description_once(self, product_id):
        ...
        url = f"https://www.instacart.com/store/dollar-tree/products/{product_id}"
...
if __name__ == "__main__":
    ...
    dollar_tree = DollarTreeSearcher(proxy)

    dollar_tree.warmup()

    product = dollar_tree.search("Scott ComfortPlus Toilet Paper")
