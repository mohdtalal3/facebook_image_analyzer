...
class SamsClubSearcher:
    """Sam's Club product search via Instacart's GraphQL search endpoint —
    the same API ALDI's, Costco's, Kroger's and Publix's storefronts use
    (identical persisted-query hash and response shape), just on
    instacart.com with Sam's Club's shop/zone ids."""
    ...
    def warmup(self, max_retries: int = 3):
        ...
        for attempt in range(1, max_retries + 1):
            try:
                r = self.session.get(
                    "https://www.instacart.com/store/sams-club",
    ...
    def _search_once(self, query):
        ...
        variables = {
            "action": None,
            "query": query,
            "pageViewId": "3ec700b1-768c-5048-877f-1278e4d94b82",
        ...
        headers = {
            ...
            "referer": f"https://www.instacart.com/store/sams-club/s?k={quote(query)}",
            "x-client-identifier": "web",
            "x-client-user-id": "21192267958514052",
            "x-ic-view-layer": "true",
            "x-page-view-id": "3ec700b1-768c-5048-877f-1278e4d94b82",
        }
        ...
        # with open(Path(__file__).parent / "samsclub_last_response.json", "w", encoding="utf-8") as f:
        #     json.dump(data, f, indent=2, ensure_ascii=False)
        # print("✓ Raw response saved to samsclub_last_response.json")
        ...
        return {
            ...
            "product_url": f"https://www.instacart.com/store/sams-club/products/{evergreen_url}",
    ...
    def _get_description_once(self, product_id):
        ...
        url = f"https://www.instacart.com/store/sams-club/products/{product_id}"
...
if __name__ == "__main__":
    ...
    samsclub = SamsClubSearcher(proxy)

    samsclub.warmup()

    product = samsclub.search("Honey Apple salad kit")
