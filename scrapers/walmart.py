...
class WalmartSearcher:
    """Walmart product search via Instacart's GraphQL search endpoint —
    the same API the other storefront scrapers use (same response shape),
    just on instacart.com with Walmart's shop/zone ids."""
    ...
    def warmup(self, max_retries: int = 3):
        ...
        for attempt in range(1, max_retries + 1):
            try:
                r = self.session.get(
                    "https://www.instacart.com/store/walmart",
    ...
    def _search_once(self, query):
        ...
        variables = {
            "action": None,
            "query": query,
            "pageViewId": "7e4579b4-6332-5a27-8e13-584104473a7a",
        ...
        extensions = {
            "persistedQuery": {
                "version": 1,
                "sha256Hash": "3ccf54c4ce03969cade425d60aaac8fe646d29ddaa3221eeacaf2ae7d112f2c5",
            }
        }
        ...
        headers = {
            ...
            "referer": f"https://www.instacart.com/store/walmart/s?k={quote(query)}",
            "x-client-identifier": "web",
            "x-client-user-id": "21192267958514052",
            "x-ic-view-layer": "true",
            "x-page-view-id": "7e4579b4-6332-5a27-8e13-584104473a7a",
        }
        ...
        # with open(Path(__file__).parent / "walmart_last_response.json", "w", encoding="utf-8") as f:
        #     json.dump(data, f, indent=2, ensure_ascii=False)
        # print("✓ Raw response saved to walmart_last_response.json")
        ...
        return {
            ...
            "product_url": f"https://www.instacart.com/store/walmart/products/{evergreen_url}",
    ...
    def _get_description_once(self, product_id):
        ...
        url = f"https://www.instacart.com/store/walmart/products/{product_id}"
...
if __name__ == "__main__":
    ...
    walmart = WalmartSearcher(proxy)

    walmart.warmup()

    product = walmart.search("YoCrunch Oreo Vanilla Lowfat Yogurt with Oreo Cookie Pieces")
