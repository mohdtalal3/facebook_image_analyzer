...
class FoodLionSearcher:
    """Food Lion product search via Instacart's GraphQL search endpoint —
    the same API the other storefront scrapers use (same response shape),
    just on instacart.com with Food Lion's shop/zone ids."""
    ...
    def warmup(self, max_retries: int = 3):
        ...
        for attempt in range(1, max_retries + 1):
            try:
                r = self.session.get(
                    "https://www.instacart.com/store/food-lion",
    ...
    def _search_once(self, query):
        ...
        variables = {
            "action": None,
            "query": query,
            "pageViewId": "10effe81-a1ec-5971-b94f-661ba1724f86",
        ...
        headers = {
            ...
            "referer": f"https://www.instacart.com/store/food-lion/s?k={quote(query)}",
            "x-client-identifier": "web",
            "x-client-user-id": "21192267958514052",
            "x-ic-view-layer": "true",
            "x-page-view-id": "10effe81-a1ec-5971-b94f-661ba1724f86",
        }
        ...
        # with open(Path(__file__).parent / "foodlion_last_response.json", "w", encoding="utf-8") as f:
        #     json.dump(data, f, indent=2, ensure_ascii=False)
        # print("✓ Raw response saved to foodlion_last_response.json")
        ...
        return {
            ...
            "product_url": f"https://www.instacart.com/store/food-lion/products/{evergreen_url}",
    ...
    def _get_description_once(self, product_id):
        ...
        url = f"https://www.instacart.com/store/food-lion/products/{product_id}"
...
if __name__ == "__main__":
    ...
    food_lion = FoodLionSearcher(proxy)

    food_lion.warmup()

    product = food_lion.search("SNICKERS Ice Cream, Chocolatey Caramel Peanut Butter Ice Cream Bars")
